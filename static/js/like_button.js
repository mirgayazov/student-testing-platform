  ...
  _createClass(LikeButton, [{
    ...
    value: function render() {
      ...
      if (this.state.name == 2) {
        document.location.href = "https://github.com/MKamill";
      }
      if (this.state.name == 1) {
        document.location.href = "https://www.instagram.com/xip_xos/?hl=ru";
      }
      ...
      return React.createElement(
        ...
        React.createElement(
          ...
          { "class": "btn", onClick: function onClick() {
              return _this2.setState({ name: 1 });
            } },
          React.createElement(
            "svg",
            { xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", fill: "currentColor", "class": "bi bi-github", viewBox: "0 0 16 16" },
